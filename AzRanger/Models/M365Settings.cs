...
namespace AzRanger.Models
{
    public class M365Settings
    {
        ...
        public List<ActivityBasedTimeoutPolicy> ActivityBasedTimeoutPolicy { get; set; }
        public List<DlpLabelPolicy> DlpLabelPolicies { get; internal set; }
        public List<LegacyPolicy> LegacyPolicies { get; internal set; }
        public List<GroupSetting> GroupSettings { get; internal set; }
    }
}

...
namespace AzRanger.Utilities
{
    class CommandlineOptions
    {
        ...
        [Option('p', "password", HelpText = "Specify the password.")]
        ...
        [Option('d', "devicecode", Default = false, Required = false, HelpText = "Use device code flow for authentication (headless environments).")]
        ...
        [Option(Required = false, HelpText = "Only for audit. Specify 'console', 'html', 'json' or 'csv'.", Default = AzRangerOutput.HTML)]
        ...
        [Option(Default = false, Required = false, HelpText = "Disable persistent token cache and delete existing cache file.")]

...
namespace AzRanger.Checks
{
    ...
    internal class CISM365Info
    {
        ...
        public static bool TryGet(string identifier, out CISM365Info info)
        {
            ...
            info.Version = section.GetStringOrNull("CISM365version") ?? section.GetStringOrNull("CISM365Version");

            if (!Enum.TryParse(section.GetStringOrNull("CISM365Level"), out CISLevel level))
            {
                info = null;
                return false;
            }

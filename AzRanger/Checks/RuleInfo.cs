...
namespace AzRanger.Checks
{
    ...
    internal class RuleInfo
    {
        ...
        public static bool TryGet(string identifier, out RuleInfo ruleInfo)
        {
            ...
            ruleInfo.CISM365version = section.GetStringOrNull("CISM365version") ?? section.GetStringOrNull("CISM365Version");
            ruleInfo.CISAZSection = section.GetStringOrNull("CISAZSection");
            ruleInfo.CISAZLevel = section.GetStringOrNull("CISAZLevel");
            ruleInfo.CISAZversion = section.GetStringOrNull("CISAZVersion") ?? section.GetStringOrNull("CISAZversion");
